...
export default function Page() {
  ...
  return (
    <main className="bg-[rgb(var(--bg))] text-[rgb(var(--fg))]">
      ...
      <section className="relative min-h-[92vh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-5 pt-36 pb-16 text-center">
          ...
          <h1 className="mt-4 font-[var(--font-serif)] text-5xl sm:text-6xl md:text-7xl tracking-tight">
            {lang === "sr" ? "Una Trattoria  Italijanski restoran i picerija" : "Una Trattoria – Italian Restaurant & Pizzeria"}
          </h1>
 
          <p className="mx-auto mt-6 max-w-2xl text-white/70 leading-relaxed">
            {lang === "sr"
              ? "Autentična napuljska pica, sveže paste i italijanski specijaliteti u srcu Beograda. Vaša omiljena picerija na Vračaru."
              : "Looking for great food near you? Enjoy the best Neapolitan pizza and fresh pasta in the heart of Vračar, Belgrade."}
          </p>
      ...
      <SplitSection
        title={lang === "sr" ? "O nama" : "About Us"}
        text={lang === "sr"
          ? "Kao vaš omiljeni italijanski restoran blizu vas, Una Trattoria je nastala iz ljubavi prema originalnim receptima. Naša picerija nudi pravu napuljsku pizzu od dugo fermentisanog testa, pečenu na visokoj temperaturi. Bilo da tražite savršeno mesto za ručak na Vračaru ili vrhunsku pizzu, tu smo za vas."
          : "If you are searching for top-rated restaurants near me or an authentic Italian restaurant in Belgrade, Una Trattoria is your perfect choice. We serve traditional Neapolitan pizza baked at high temperatures and delicious homemade pasta. Find the best pizza near me right here in Vračar."}
...
<section className="relative bg-black/80 border-y border-white/10 overflow-hidden">
  ...
  <div className="relative mx-auto max-w-6xl px-5 py-28 text-center">
    ...
    <div className="text-xs tracking-[0.35em] uppercase text-[#d6b36a]/80">
      {lang === "sr" ? "Brza pizza dostava" : "Fast Delivery"}
    </div>
 
    <h2 className="mt-4 font-[var(--font-serif)] text-4xl sm:text-5xl tracking-tight">
      {lang === "sr" ? "Dostava pice Vračar" : "Pizza Delivery Belgrade"}
    </h2>
 
    <p className="mx-auto mt-6 max-w-2xl text-white/70 leading-relaxed">
      {lang === "sr"
        ? "Želite italijansku hranu kod kuće? Brza dostava pice i pasti preko naših partnera na teritoriji Vračara i šire."
        : "Craving Italian food at home? Order the best pizza and pasta delivery through our partners Wolt and Glovo."}
    </p>
