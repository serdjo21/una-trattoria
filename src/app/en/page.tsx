        ...
        <div className="grid gap-10 md:grid-cols-3">
          <div className="space-y-3">
            ...
            <p className="text-white/60 text-sm leading-relaxed">
              Authentic Italian cuisine, traditional recipes and a warm
              atmosphere in the heart of Belgrade.
            </p>
          </div>
...
export default function Page() {
  ...
  return (
    <main className="bg-[rgb(var(--bg))] text-[rgb(var(--fg))]">
      ...
      <section className="relative min-h-[92vh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-5 pt-36 pb-16 text-center">
          ...
          <h1 className="mt-4 font-[var(--font-serif)] text-5xl sm:text-6xl md:text-7xl tracking-tight">
            Una Trattoria – Italian Restaurant & Pizzeria
          </h1>
 
          <p className="mx-auto mt-6 max-w-2xl text-white/70 leading-relaxed">
            Looking for great food near you? Enjoy the best Neapolitan pizza and
            fresh pasta in the heart of Vračar, Belgrade.
          </p>
      ...
      <SplitSection
        title="About Us"
        text="If you are searching for top-rated restaurants near you or an authentic Italian restaurant in Belgrade, Una Trattoria is your perfect choice. We serve traditional Neapolitan pizza baked at high temperatures and delicious homemade pasta. Find the best pizza in Vračar right here."
      ...
      <SplitSection
        title="Our Menu"
        text="Discover a wide selection of authentic Italian dishes, from traditional Neapolitan pizza to fresh homemade pasta and desserts."
        cta="View Menu"
        href="/menu"
...
<section className="relative bg-black/80 border-y border-white/10 overflow-hidden">
  ...
  <div className="relative mx-auto max-w-6xl px-5 py-28 text-center">
    ...
    <h2 className="mt-4 font-[var(--font-serif)] text-4xl sm:text-5xl tracking-tight">
      Pizza Delivery Belgrade
    </h2>
 
    <p className="mx-auto mt-6 max-w-2xl text-white/70 leading-relaxed">
      Craving Italian food at home? Order the best pizza and pasta delivery
      through our partners Wolt and Glovo.
    </p>
